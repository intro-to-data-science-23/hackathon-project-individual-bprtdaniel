...
create_facet_plot <- function(survey_data, var_name, relative = FALSE) {
  # Example: Retrieving question label and data source from survey_data attributes
  # Adjust these lines as per your dataset's structure
  ...
  survey_data[[var_name]] <- as.factor(survey_data[[var_name]])
